...
#ifndef MIRTK_MapConstraint_H
#define MIRTK_MapConstraint_H
...
/**
 * Base class of surface or volumetric map constraints
 */
class MapConstraint : public Object
{
  mirtkAbstractMacro(MapConstraint);
